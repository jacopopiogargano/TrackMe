...
\section{Product functions}
	...
	\subsection{AutomatedSOS}
		...
		The service will constantly monitor \ic{User}'s health data to verify if it is \ic{Anomalous}. Data acquisition frequency can be tweaked only by Data4Help, however AutomatedSOS may request a different value according to \ic{User} needs.
	...
	\subsection{Track4Run}
		...
		\ic{Organizers} have the ability of creating a \ic{Run}. They will be able to give the \ic{Run} a name, set a date and time the \ic{Run} is going to be held on and define a path for it. Moreover, they may limit the number of \ic{Participants} or decide when to close enrollment (see R\subs{41}).
