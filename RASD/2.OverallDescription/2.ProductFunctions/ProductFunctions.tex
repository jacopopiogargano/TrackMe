...
\section{Product functions}
			\subsection{Data4Help}
				...
				The \ic{User} registration process will be carried out on the Data4Help application (see \todo{add reference to where we are going to specify the user interface} and \todo{add reference to User Sign Up use case}.\\
			...
			\subsection{Track4Run}
				...
				Track4Run will display a map with the real time position of all the \ic{Participants} during a \ic{Run}. \ic{Spectators} may watch a \ic{Run} by inserting its identifier or name.
