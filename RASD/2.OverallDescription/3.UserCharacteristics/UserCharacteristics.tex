...
\paragraph{Users:}
	People having at least a device with a sensor connected to the Internet, willing to share their data (see \ic{User data} in section \hyperref[sect:1.4.1]{1.4.1}) with TrackMe so as to use the \ic{Services} built on top of Data4Help.
