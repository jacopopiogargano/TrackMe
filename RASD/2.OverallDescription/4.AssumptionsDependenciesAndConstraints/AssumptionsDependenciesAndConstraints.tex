...
\section{Assumptions, Dependencies and Constraints}
		\subsection{Domain Assumptions}
			 	\begin{itemize}
					...
					\item[D\subs{9}]Local emergency services always have an available ambulance to send to the \ic{User in need} location.
					\item[D\subs{10}]All applications and \ic{Services}, including Data4Help, AutomatedSOS and Track4Run, are always connected to the Internet.
