...
\section{Assumptions, Dependencies and Constraints}
		\subsection{Domain Assumptions}
			 	\begin{itemize}
					...
					\item[D\subs{4}]A \ic{Third Party} can receive consent to \ic{User data} access only through a service it offers and can use the data only for that specific service.
