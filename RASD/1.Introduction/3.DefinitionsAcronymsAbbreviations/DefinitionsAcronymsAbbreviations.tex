...
\section{Definitions, Acronyms, Abbreviations}
		...
		\begin{description}
			\item[User]: registered user of Data4Help who agreed on the acquisition and processing of their data (see \todo{add reference to user data below}. 
			\item[Third party]: a company that can access user data stored in TrackMe's database, after user consent.
			...
			\item[User data]: User's health data and location acquired by Data4Help
			\item[Group data]: a group of Users data acquired by Data4Help
