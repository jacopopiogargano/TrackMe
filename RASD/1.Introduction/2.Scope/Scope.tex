...
\begin{enumerate}
	\item \ic{User} moves.
	\item \ic{User} can have health problems.
	\item \ic{Smart wearable} sensors acquire data.
	\item \ic{Smart wearables} communicate.
	\item \ic{Smart wearable} sensors break.
	\item \ic{Third parties} collect data from Data4Help.
	\item \ic{Third parties} register to Data4Help.
	\item \ic{User} grants direct usage of personal data.
	\item \ic{User} adds a new \ic{Service}.
	\item \ic{Organizers} define a path for a \ic{Run}.
	\item \ic{Participant} enrolls in a \ic{Run}.
