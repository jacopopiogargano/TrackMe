...
\section{Software System Attributes}
			...
			The reliability of the system mainly depends on that of \ic{Smart Wearables} in use whose purpose is to collect \ic{User data}. It also depends on the reliability of the Internet connection when it comes to sending data to Data4Help and to \ic{Third parties}.\\
			AutomatedSOS downtime must be minimal, in order to provide assistance to all \ic{Users in need}. Fault detection time must be kept minimum so as to promptly identify a fault and repair it as soon as possible.
