...
\section{Other Design Decisions}
	...
	\subsection{Interfaces Use}
		...
		\begin{itemize}
			\item Data Interface
			\begin{itemize}
				\item SmartWearable \todo{In teoria è usata dallo Smart Wearable, ma dovrebbe chiamare collectData della classe Model. Metto Model o lascio SmartWearable?}
			\end{itemize}
		\end{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				\item Data4Help Server \todo{Model o Controller?}
			\end{itemize}
		\end{itemize}
