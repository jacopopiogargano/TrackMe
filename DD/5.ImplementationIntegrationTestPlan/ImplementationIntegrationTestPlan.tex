...
\end{enumerate}
As previously written, the interfaces-enabled independece of all the components enable to eventually change this plan according to team size and costs constraints. \todo{si può decidere di togliere questo paragrafo per esigenze di impaginazione }
